...
const CATEGORIES = [
    { label: "전체", value: "All" },
    { label: "유소년아카데미", value: "Youth" },
    { label: "성인트레이닝", value: "Adult" },
    { label: "TNT W", value: "TNTW" },
    { label: "체험 수업", value: "Trial" }
];
    ...
    return (
        <div>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                <h1 className="text-2xl font-bold text-navy-900">신청서 관리</h1>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                {CATEGORIES.map((cat) => (
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg font-bold text-sm transition ${filterType === cat.value

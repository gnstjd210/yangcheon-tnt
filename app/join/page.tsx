...
export default function JoinPage() {
    ...
    const handleSocialLogin = (provider: 'naver' | 'google' | 'kakao') => {
        ...
        signIn(provider, { callbackUrl: "/signup/sns" });
    };
                ...
                <div className="flex gap-4 justify-center">
                    ...
                    >
                        <svg className="w-7 h-7" viewBox="0 0 24 24" fill="#000000">
                            <path d="M12 3c-5.5 0-10 3.5-10 7.8 0 2.8 1.8 5.2 4.6 6.5-.1.5-.5 1.7-.5 1.7s-.1.4.1.5c.2.1.5.1.5.1l2.1-1.4c1 .3 2.1.4 3.2.4 5.5 0 10-3.5 10-7.8S17.5 3 12 3z" />
                        </svg>
                    </button>
                </div>
            </div>
